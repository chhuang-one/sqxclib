...
You can use SqQuery alone if you copy SqQuery.h, SqQuery.c, and SqQueryMethod.h to other software projects and set SQ_QUERY_USE_ALONE to 1 in SqQuery.h header file.

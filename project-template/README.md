...
#### /sqapp
This directory contain sqtool and static libraries 'sqapp-data'.

#### /database/migrations
This directory contain C or C++ migration files that generated by sqtool (or sqtool-cxx).  
CMake or meson will compile these migration files into static libraries 'sqapp-data'.
...
1. ***FindSqxc.cmake***  is cmake module to find Sqxc (sqxclib). You can remove it if system has it.

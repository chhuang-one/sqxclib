...
#define SQB_INDEX          (1 << 9)   // SQL: INDEX
#define SQB_INCREMENT      (1 << 10)  // SQL: AUTOINCREMENT
#define SQB_AUTOINCREMENT  (1 << 10)  // SQL: AUTOINCREMENT
#define SQB_NULLABLE       (1 << 11)  // SQL: remove "NOT NULL"
#define SQB_UNSIGNED       (1 << 12)  // SQL: attribute "UNSIGNED"
